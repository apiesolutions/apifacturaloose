...
class Functions
{
    ...
    public static function person($inputs, $type) {
        ...
        if(in_array($inputs['identity_document_type_id'],['1','6']))
    ...
    public static function DNI($inputs){
        ...
        //     if (!in_array($person->identity_document_type_id, ['1','4','6','7'])) throw new Exception("El tipo doc. identidad {$person->identity_document_type->description} del cliente no es valido.");
        // }
    }
}