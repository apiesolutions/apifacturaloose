...
use App\Models\Catalogs\RetentionType;
...
class Retention extends Model
{
    ...
    {
        return route('download.external_id', ['model' => 'retention', 'type' => 'xml', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalPdfAttribute()
    {
        return route('download.external_id', ['model' => 'retention', 'type' => 'pdf', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalCdrAttribute()
    {
        return route('download.external_id', ['model' => 'retention', 'type' => 'cdr', 'external_id' => $this->external_id]);
    }
}